package com.chany.viewmodeldemo
...
import com.chany.viewmodeldemo.ui.theme.PracticeTheme
...
fun InputRow(
    ...
    Row(verticalAlignment = Alignment.CenterVertically) {
        ...
        Crossfade(
            ...
            when (visible) {
                true -> Text("\u2109", style = MaterialTheme.typography.bodyMedium)
                false -> Text("\u2103", style = MaterialTheme.typography.bodyMedium)
            }
        }
    }
}
